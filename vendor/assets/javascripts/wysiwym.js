...
Wysiwym.Markdown = function(textarea) {
	...
	'|',
        ...
        new Wysiwym.Button('Header 3',  Wysiwym.list,  {prefix:'### ',   wrap:true}),
        new Wysiwym.Button('Header 2',  Wysiwym.list,  {prefix:'## ',   wrap:true}),
        new Wysiwym.Button('Header 1',  Wysiwym.list,  {prefix:'# ',   wrap:true}),
